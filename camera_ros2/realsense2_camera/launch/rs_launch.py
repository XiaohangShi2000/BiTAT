...
configurable_parameters = [{'name': 'camera_namespace',             'default': 'head', 'description': 'namespace for camera'},
                           {'name': 'camera_name',                  'default': 'd435i', 'description': 'camera unique name'},
                           {'name': 'serial_no',                    'default': '_231522070653', 'description': 'choose device by serial number'},
                           ...
                           {'name': 'rgb_camera.exposure',          'default': '100', 'description': 'rgb stream manual exposure value'},
                           {'name': 'rgb_camera.gain',              'default': '56', 'description': 'rgb stream manual gain value'},
