...
from leap_hand_utils.robot import Robot
...
class DynamixelRobot(Robot):
    ...
    def __init__(
        ...
        from leap_hand_utils.dynamixel_driver import (
            DynamixelDriver,
        ...
        if real:
            self._driver = DynamixelDriver(joint_ids, port=port, gripper_config=gripper_config)
